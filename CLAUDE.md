# Family Zoo — v01 — A Single Room — Claude Project Memory
...
**Name:** Family Zoo — v01 — A Single Room
**Purpose:** Sharpee tutorial step 1 — A Single Room.
...
**Repository:** https://github.com/Johnesco/familyzoo-v01
**Live:** https://johnesco.github.io/familyzoo-v01/
...
├── familyzoo-01.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v01.story`.
